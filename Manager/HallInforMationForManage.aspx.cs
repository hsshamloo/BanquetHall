...
public partial class HallInforMationForManage : System.Web.UI.Page
{
    DataClassesDataContext context = new DataClassesDataContext();
    ReservationAndCancelation rac = new ReservationAndCancelation();
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            foreach (var singleHall in avaliabelHalls)
            {
                ...
                if (rac.isReservedHall(singleHall.ReHallId1))
                {
                ...
                {
                    showAvailableHall.EditView = true;
                    showAvailableHall.DeletView = true;
                }
