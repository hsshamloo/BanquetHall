<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RegisterNewHall.ascx.cs" Inherits="RegisterNewHall" %>
...
<div class= "MiddelChild">
    <asp:DropDownList ID="HalTypeTxt" runat="server" CssClass="PersianText" 
        style="font-size: small" Width="235px">
        ...
        <asp:ListItem>تالار همایش</asp:ListItem>
    </asp:DropDownList>
</div>
<div class="RightChild">
    :نوع تالار</div>
...
<div class="fieldBigExtrem" style="text-align: center" 
    ...
    <asp:TextBox ID="HallFullDescriptionTxt" runat="server" Height="220px" TextMode="MultiLine" 
        Width="693px" Font-Names="Tahoma" Font-Size="Large"></asp:TextBox>
...
<div class="MiddelChild">
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        ImageUrl="~/Image/registerHallButton.png" onclick="ImageButton1_Click" />
